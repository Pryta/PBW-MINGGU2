...
//kamus
    ...
    //jika ada spasi
    char ArrKalimat[50]; //tanpa input  //= "AKU CAH DINUS "; /* bisa juga ditulis */ //= {'A', 'K', 'U', ' ', 'C', 'A', 'H', ' ', 'D', 'I', 'N', 'U', 'S'};
...
//deskripsi
    ...
    {
        //coba gunakan input
        cout << "Kalimat    : "; cin.getline(ArrKalimat, 50);
        strupr(ArrKalimat);
        cout << ArrKalimat;
